...
public class GaussianEdgeDetector {
    ...
    public BufferedImage applyGaussianEdgeDetection(BufferedImage image, int strength) {
        // Step 1: Apply Gaussian Blur
        BufferedImage blurredImage = applyGaussianBlur(image, strength);

        // Step 2: Calculate Gradient Intensity and Direction using Sobel operators
